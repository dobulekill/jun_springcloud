package com.ms.monitor.test.service;

import java.io.IOException;
import java.util.HashMap;
import java.util.Map;

import com.ms.monitor.test.ConfigCons;
...
public class ServiceList {
	...
	public static void main(String[] args) throws IOException {
		...
		params.put("serviceId", "ms-cloud-monitor");
		
		String result = FrameHttpUtil.post(ConfigCons.address + "/api/service/serviceList", params);
