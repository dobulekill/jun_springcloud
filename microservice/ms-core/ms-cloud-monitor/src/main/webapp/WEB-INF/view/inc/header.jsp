...
<div class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="${webroot}/index.jsp">${projectName}</a>
	</div>
	<div id="headerMenu" class="navbar-collapse collapse">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li id="hmMain" class="dropdown">
				<a href="${webroot}/sysUser/f-view/main.shtml">${user.nickname}</a>
			</li>
			<li id="hmExit"><a href="${webroot}/sysUser/f-view/logout.shtml">退出</a></li>
			</c:when>
			<c:otherwise>
