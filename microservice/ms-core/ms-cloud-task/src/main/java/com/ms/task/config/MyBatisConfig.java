...
@MapperScan(basePackages = {"com.task.schedule.manager.dao" })
public class MyBatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DynamicDataSource ds) throws Exception {
        ...
        String typeAliasesPackage = "com.task.schedule.manager.pojo;";
        ...
        .getResources("classpath*:com/task/schedule/manager/dao/*.xml")));
