...
import com.zscatcloud.JacksonUtil;
import com.zscatcloud.PubUtils;
import com.zscatcloud.base.dto.LoginAuthDto;
import com.zscatcloud.core.annotation.LogAnnotation;
import com.zscatcloud.core.annotation.OperationLogDto;
import com.zscatcloud.core.utils.RequestUtil;
import com.zscatcloud.wrapper.Wrapper;
...
public class LogAspect {
	 ...
	 * Log annotation.
	 */
	@Pointcut("@annotation(com.zscatcloud.core.annotation.LogAnnotation)")
	...
	private void handleLog(final JoinPoint joinPoint, final Object result) {
		...
		try {
			...
			threadLocal.remove();
			taskExecutor.execute(() -> this.restTemplate.postForObject("http://zscatcloud-provider-uac/auth/saveLog", operationLogDto, Integer.class));
		} catch (Exception ex) {
