...
public class RedisKeyUtil {
	 ...
	 */
	private static final String RESET_PWD_TOKEN_KEY = "zscatcloud:restPwd";
	private static final String ACTIVE_USER = "zscatcloud:activeUser";
	private static final String SEND_SMS_COUNT = "zscatcloud:sms:count";
	private static final String SEND_EMAIL_CODE = "zscatcloud:email:code";
	private static final String ACCESS_TOKEN = "zscatcloud:token:accessToken";
	private static final String UPLOAD_FILE_SIZE = "zscatcloud:file:upload_file_size";
