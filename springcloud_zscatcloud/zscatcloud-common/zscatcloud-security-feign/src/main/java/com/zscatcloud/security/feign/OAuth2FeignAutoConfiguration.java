...
public class OAuth2FeignAutoConfiguration {
	 ...
	 */
	@Bean("zscatcloudClientCredentialsResourceDetails")
	 ...
	 */
	@Bean("zscatcloudOAuth2RestTemplate")
	 ...
	 */
	@Bean
	public RequestInterceptor oauth2FeignRequestInterceptor(@Qualifier("zscatcloudOAuth2RestTemplate") OAuth2RestTemplate oAuth2RestTemplate) {
